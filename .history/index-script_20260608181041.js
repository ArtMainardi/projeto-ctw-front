async function logar(){
    ...
    message.innerHTML = resposta.;

    if(resposta.message == "Login efetuado com sucesso! (aluno)" || resposta.message == "Login efetuado com sucesso! (aluno)" || resposta.message == "Login efetuado com sucesso! (aluno)"){
