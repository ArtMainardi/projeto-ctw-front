async function logar(){
    ...
    if(resposta.tipoUsuario == "Login efetuado com sucesso! (aluno)" || resposta.message == "Login efetuado com sucesso! (aluno)" || resposta.message == "Login efetuado com sucesso! (aluno)"){
